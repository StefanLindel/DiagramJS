...
class SearchComponent {
	...
	public printSearchbar(parent:HTMLElement) {
		...
		this.searchInput.onchange = function(event) {that.searchItems(event);};
	...
	public showItems(origSearchText){
		if (!origSearchText){origSearchText = "";}
	...
	TableView.prototype.searchFull = function(root, split) {
	var items = new ItemList(this.options);
	...
	TableView.prototype.searching = function(item, split) {
	var fullText ="";
...
class Table extends Control {
	...
	constructor(owner, data) {
		...
		//if(data["searchproperty"]){
			...
			this.$searchControl.printSearchbar(searchBar);
